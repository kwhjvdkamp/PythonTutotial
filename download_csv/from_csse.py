...
#
def calculateDiffWithPreviousRowValue():
    return
...
dfConfirmedExtended=pd.DataFrame(dictConfirmedExtended)
...
dfDeceasedExtended=pd.DataFrame(dictDeceasedExtended)
...
dfRecoveredExtended=pd.DataFrame(dictRecoveredExtended)
