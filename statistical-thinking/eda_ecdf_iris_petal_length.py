...
# print(df_iris_data)
column_name_setosa = df_iris_data.columns[0]
...
# iris_petal_length = df_iris_data.iloc[0:-1,0:1].values
# ---------------------------------------------------
setosa_petal_length = pd_df[(pd_df[column_name_target] == target_names.tolist().index(name_setosa))].iloc[0:-1, 0:1].values
# print(setosa_petal_length)
versicolor_petal_length = pd_df[(pd_df[column_name_target] == target_names.tolist().index(name_versicolor))].iloc[0:-1, 0:1].values
# print(versicolor_petal_length)
virginica_petal_length = pd_df[(pd_df[column_name_target] == target_names.tolist().index(name_virginica))].iloc[0:-1, 0:1].values
