...
# ]
print(len( diversions[2].xpath('./*') ))
# OUTPUT
# 3
print(len( diversions[2] ))
# OUTPUT
# TypeError: object of type 'Selector' has no len()
# The code diversions[2] is one element from a SelectorList, and therefore is a Selector (not another SelectorList)
